...
/**
 * Diese Klasse sammelt Systeminformationen über das Gerät.
 * Dazugehören Informationen über das Gerät, Informationen über das Netzwerk in welchem sich das Gerät befindet,
 * Informationen über die Androidversion, welche auf dem Gerät installiert ist und schließlich noch Informationen über die im Gerät verbauten Sensoren.
 */
public class AdvancedSystemInfo {
	...
	/**
	 * Der Konstruktor weist die entspechenden Daten den Klassenvaribalen zu. Außerdem erstellt er ein neues AdvancedInformationPacket Objekt.
	...
	public void networkInfo() {
		/**
		 * Um Informationen über die Netzwerke zu erhalten benötigt man einen ConnectivityManager.
		 * Um dann genaue Informationen über ein bestimmtes Netzwerk zubekommen, muss man auf die Vaiablen des Connectivity Managers zugreifen.
		 */
		...
		/**
		 *Die Informationen werden dann p hinzugefügt. Beim mobilen Netz handelt es sich um die Geschwindigkeit, die zu Verfügung steht, ob das Netz vorhanden ist,
	...
	/**
	 * Mit Hilfe dieser Methode lassen sich Informationen über die AndroidVersion auslesen.
	...
	public void sensorsInfo() {
		/**
		 * Mit Hilfe eines SensorManager ist es möglich eine Liste aller Sensoren des Gerätes zu erhalten.
		...
		/**
		 * Die for-Schleife erstellt eine ArrayListe aus Strings und fügt dieser die Namen der Sensoren hinzu.
		 */
