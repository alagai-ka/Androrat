...
/**
 * Der Sinn dieser Klasse ist nicht offensichtlich. Es scheint als sei dies ursprünglich als MainKlasse angedacht worden, wurde jedoch im nachhinein durch die LauncherActivity ersetzt.
...
public class AndroratActivity extends Activity {
    /** Diese Funktion wir aufgerufen wenn die Activtiy erstellt wird. Hier soll dann das Layout auf das R.layout.main gesetzt werden und zustätzlich, falls der Zustand gespeichtert wurde dieser wiederhergestellt werden.
