...
/**
 * Diese Klasse startet die Client Activity wenn das Gerät gebootet wurde. Es ist als dafür da, die Anwendung auch nach dem Booten des Gerätes automatisch zu starten.
 * Zustäzlich handelt es sich bei dieser Klasse um einen BroadcastReceiver. Diese Komponenten empfängt systemweite Broadcast und verarbeitet diese.
 */
...
public class BootReceiver extends BroadcastReceiver {
	...
	public void onReceive(Context context, Intent intent) {
		/**
		 * Für Testzwecke wird dem Log ein String übergeben um anzuzeigen, das es erfolgreich funktioniert hat.
		 */
		...
		/**
		 * Überprüft ob der String action derselbe ist wie der String "Intent.ACTION_BOOT_COMPLETED". Dieser Intent wird gesendet sobald das Gerät gebootet wurde.
