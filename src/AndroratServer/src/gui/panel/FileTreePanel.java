...
public class FileTreePanel extends JPanel {
	...
	/**
	 * Diese Methode erh�lt eine Liste von MyFiles und erstellt daraus einen Ordnerbaum. Dieser wird dann auf der GUI angezeigt.
	...
	/**
	 * Diese Methode ist zum Anzeigen und Hinzuf�gen von Kindknoten vorhanden.
	...
	/**
	 * Diese Methode wird ben�tigt, sobald ein Ordner angeklickt wird um die entsprechenden Informationen �ber diesen auszulesen und anzuseigen.
	...
	/**
	 * Diese Methode wird aufgerufen sobald er Button Download File gedr�ckt wird.
	...
	/**
	 * Diese Methode ruft die Methode fireTreeFile der KLasse GUI auf sobald auf den Button Get FileTree gedr�ckt wird.
